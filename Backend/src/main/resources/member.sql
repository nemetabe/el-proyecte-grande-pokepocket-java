...
INSERT INTO evolution_chains (id, base_pokemon_id, evolved_pokemon_id, evolution_trigger, min_happiness)
VALUES
    (
        1,
...
INSERT INTO user_pokemon (id, species_id, user_id, nickname, happiness, picture_url, gif_url, hatch_date, is_evolution_pending)
VALUES (
           1,
           (SELECT id FROM pokemon_species WHERE poke_index_number = 25), -- Pikachu
           1, -- Ash's user ID
